...
print("Starting SE2A Aircraft FMU Benchmark...")
...
try:
    ...
    t_stop = 10.0  # 10 seconds simulation
    dt = 0.01      # 100 Hz communication interval (1000 steps total)
    ...
    # --- 2. Simulation Loop ---
    print("\nRunning simulation loop (no console prints to prevent I/O overhead)...")
    sim_start = time.perf_counter()
    
    current_time = 0.0
    steps = 0
    while current_time <= t_stop + 1e-9:
        # Retrieve outputs (to simulate realistic load of reading results)
